...
| `$BP_MAVEN_SETTINGS_PATH`  | Specifies a custom location to maven's `settings.xml` file. If `$BP_MAVEN_SETTINGS_PATH` but a maven binding is provided, the binding takes the higher precedence.  |
